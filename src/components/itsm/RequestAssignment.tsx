...
export function RequestAssignment({ 
  ...
  const assignRequest = async (assigneeId: string | null) => {
    try {
      setAssigning(true);
    ...
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      ...
      <PopoverContent className="w-64 p-0" side="bottom" align="start">
        <div className="p-3 border-b">
          <h4 className="font-medium text-sm">Assigner la demande</h4>
