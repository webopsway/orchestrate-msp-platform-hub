...
CREATE POLICY "Managers and MSP admins can assign roles"
    ...
    USING (
        ...
        -- Team admins can assign roles in their team
...
INSERT INTO public.permissions (name, display_name, description, resource, action) VALUES
    ...
    -- Infrastructure
    ('infrastructure.view', 'Voir infrastructure', 'Consulter inventaire infrastructure', 'infrastructure', 'view'),
    ('infrastructure.create', 'Créer des ressources', 'Ajouter des ressources infrastructure', 'infrastructure', 'create'),
    ('infrastructure.update', 'Modifier infrastructure', 'Modifier les ressources', 'infrastructure', 'update'),
