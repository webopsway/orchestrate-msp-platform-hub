...
CREATE POLICY "cloud_providers_insert_policy" ON public.cloud_providers
FOR INSERT WITH CHECK (public.is_msp_admin());
CREATE POLICY "cloud_providers_update_policy" ON public.cloud_providers
FOR UPDATE USING (public.is_msp_admin());
CREATE POLICY "cloud_providers_delete_policy" ON public.cloud_providers
FOR DELETE USING (public.is_msp_admin());
